...
class DatePickerCalendar{
	...
	setUp(){
		...
		let startOfMonth = new Date(); startOfMonth.setYear(year); startOfMonth.setMonth(month); startOfMonth.setDate(1);
		let date = new Date(); date.setYear(year); date.setMonth(month); date.setDate(1); date.setHours(0,0,0,0);
		...
		//This Month
		date.setYear(year); date.setDate(1); date.setMonth(month);
